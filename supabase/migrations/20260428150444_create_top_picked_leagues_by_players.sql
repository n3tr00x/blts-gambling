...
CREATE OR REPLACE FUNCTION public.get_top_picked_leagues_by_players(season_id integer DEFAULT NULL::integer)
 RETURNS TABLE(player text, league text, country text, league_pick_count integer, total_picks integer)
 LANGUAGE sql
AS $function$
